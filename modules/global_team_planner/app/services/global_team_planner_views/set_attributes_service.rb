...
module GlobalTeamPlannerViews
  class SetAttributesService < ::BaseServices::SetAttributes
    ...
    def default_query
      ...
      # every other caller of new_default in this codebase supplies its own
      # name afterwards.
      query.name = I18n.t("global_team_planner.query_name", name: model.name.presence || "Team Schedule")
      query
    end
  end
end
